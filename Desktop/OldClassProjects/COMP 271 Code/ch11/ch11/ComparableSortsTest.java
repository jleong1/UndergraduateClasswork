...
public class ComparableSortsTest
{
    public static void main(String[ ] args)
    {
        Result result = runClasses (ComparableSortsTest.class);
    ...
    {              
         ...
         ComparableSorts.insertionSort (actual); 
         // ComparableSorts.selectionSort (actual); 
         // ComparableSorts.bubbleSort (actual); 
    ...
    {
        ComparableSorts.insertionSort (null);
        // ComparableSorts.selectionSort (actual); 
        // ComparableSorts.bubbleSort (actual); 
    } // method testNull
