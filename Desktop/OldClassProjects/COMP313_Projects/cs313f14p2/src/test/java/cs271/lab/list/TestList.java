...
public class TestList {
	...
	public void setUp() throws Exception {
        ...
        //.There are differences in performances, LinkedList has a faster performance time than ArrayList
	}
	...
	public void testAddMultiple2() {
		...
		assertEquals(Arrays.asList(33, 77, 44), list.subList(0, 3));
	...
	public void testRemoveObject() {
        ...
        // line above removes item at index 5
		// TODO fix the expected values in the assertions below
        ...
        // removes the value 5 from the list
	...
	public void testContainsAll() {
        ...
        assertEquals(list.containsAll(Arrays.asList(33,77,44,77,55)), list.containsAll(list.subList(0,5)));
		// 2) assert that list does not contain all of 11, 22, and 33
        assertNotEquals("List does not contain all 11,22, and 33",Arrays.asList(11,22,33),list.containsAll(list));
